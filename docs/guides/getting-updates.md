...
Starting a new project? Clone the latest FastReact. Everything below is for projects already in flight.
...
!!! tip "Get notified of security fixes"
    ...
    On GitHub, Watch the FastReact repository with Custom → Releases. Every `[security]` fix is also published as a GitHub Release, and critical ones are announced to customers by email.
