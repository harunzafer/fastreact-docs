---
description: "How to get updates from FastReact: why projects diverge over time, how to cherry-pick security and bug fixes, and when merging still makes sense."
keywords: "fastreact updates, git upstream, cherry-pick, security fixes, starter kit updates, merge conflicts, fork maintenance"
---

# Getting Updates

[FastReact](https://fastreact.dev) is yours to customize and extend. From the first week you will add your own migrations, routes, and pages, and your project starts to diverge from the kit. That is by design: FastReact is a starting point you own, not a framework you track.
...
- **What always works: taking specific fixes.** FastReact ships security and critical fixes as standalone commits precisely so you can cherry-pick them into any project, no matter how far it has diverged.

Starting a new project? Simply clone the latest FastReact. Everything below is for projects already in flight.

## Set Up the Upstream Remote

Every method below needs FastReact available as a remote:
...
git remote add upstream https://github.com/harunzafer/fastreact.git
```
...
**Get notified:** on GitHub, Watch the FastReact repository with Custom → Releases. Every `[security]` fix is also published as a GitHub Release, and critical ones are announced to customers by email.
...
**Extend rather than modify** to reduce merge conflicts. When you create new files instead of editing existing FastReact code, conflicts are limited to a few predictable integration points:
