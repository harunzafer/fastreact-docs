---
description: "FastReact type-safe API client: how Orval generates a TypeScript client from the FastAPI OpenAPI spec, and how to regenerate it after backend changes."
keywords: "fastreact orval, type-safe api client, openapi, typescript client generation, fastapi openapi, react api client"
---
...
Generated code lives in `frontend/app/lib/api/gen/`.
