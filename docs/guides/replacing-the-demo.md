---
description: "Replace the FastReact note copilot demo with your own application — plan your domain, build your features, and remove the demo code."
keywords: "fastreact remove demo, replace demo, note copilot, remove sample app, customize fastreact"
---

# Replacing the Demo

FastReact ships an AI copilot demo (note Improve / Summarize) to show the patterns. After this guide you can strip it and start clean on your own product.
