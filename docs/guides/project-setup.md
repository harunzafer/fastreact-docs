---
description: "How a FastReact project is set up by init.py, where configuration lives, and how to onboard teammates without re-running init."
keywords: "fastreact setup, init.py, project setup, env files, team onboarding, monorepo setup"
---
