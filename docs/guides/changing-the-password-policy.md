---
description: "Change the FastReact password policy: adjust the length limits, add your own rules with a Pydantic validator, and mirror them in the frontend forms."
keywords: "fastreact password policy, password validation, pydantic validator, custom password rules"
---
...
| Form | File |
|---|---|
| Signup | `frontend/app/routes/auth/signup.tsx` |
| Invitation accept | `frontend/app/routes/auth/invite-accept.tsx` |
| Reset password | `frontend/app/routes/auth/reset-password.tsx` |
| Change password | `frontend/app/routes/protected/profile.tsx` |
...
Leave `frontend/app/routes/auth/login.tsx` alone, for the same reason as
`SubmittedPassword`.
