---
description: "Swap FastReact's OpenAI integration for Claude (Anthropic), Gemini, or any provider by implementing the LLMClient interface — a complete drop-in Claude recipe."
