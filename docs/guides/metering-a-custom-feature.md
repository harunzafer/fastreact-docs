---
description: "Add a metered, plan-limited feature to FastReact — define a FeatureKey, set per-plan limits, enforce the quota, and optionally let credits top it up."
keywords: "fastreact metering, custom feature quota, featurekey, plan limits, usage-based feature, credit top-up"
---
