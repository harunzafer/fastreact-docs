---
description: "Deploy FastReact: API at api.yourdomain.com, app at app.yourdomain.com, landing at yourdomain.com, plus PostgreSQL. The most common, straightforward provider setups."
keywords: "fastreact deployment, deploy fastapi react, railway, vercel, digitalocean, fly.io, render, docker, postgres hosting, self-hosting"
---
...
- **Environment variables**: backend `FS_*` (see [Configuration](../reference/configuration.md)); the frontend and landing use `VITE_*` (e.g. `VITE_API_BASE_URL`).
