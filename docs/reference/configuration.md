---
description: "FastReact configuration reference — backend FS_ environment variables, per-environment behavior, CORS, and background-job (cron) settings."
keywords: "fastreact configuration, environment variables, fs_ prefix, cors, cron, pydantic settings, env reference"
---
