---
description: "FastReact is a fullstack SaaS starter kit built with FastAPI (Python) and React SPA (TypeScript). Get session auth, Google OAuth, Stripe, multi-tenancy, AI copilot with credit billing, and admin dashboards out of the box."
keywords: "fastapi, react, saas starter kit, fastapi react, fastapi react starter, react spa fastapi, saas starter kit python, ai saas starter kit, orval react, react, typescript, fullstack, authentication, multi-tenant, stripe payments, ai credit billing"
---

# Quick Start

[FastReact](https://fastreact.dev) is a fullstack SaaS starter kit built with **FastAPI** (Python) and **React** (TypeScript). Get it running locally in a few minutes, then browse [Features](features/authentication.md) for everything that's included.
