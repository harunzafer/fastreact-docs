---
description: "FastReact is a fullstack SaaS starter kit and boilerplate built with FastAPI (Python) and React Router v7 SPA (TypeScript). Get session auth, Google OAuth, Stripe, multi-tenancy, and admin dashboards out of the box."
keywords: "fastapi react, react router v7 fastapi, saas starter kit, fastapi react spa, react saas starter, saas starter kit python, fastapi fullstack template, react saas boilerplate, fastapi boilerplate, python saas boilerplate, orval react, react 19, typescript, fullstack, authentication, multi-tenant, stripe payments"
---

# FastReact

[FastReact](https://fastreact.dev) is a fullstack SaaS starter kit built with **FastAPI** (Python) and **React** (TypeScript). It gives you auth, Google OAuth, Stripe, multi-tenancy, admin & user dashboards, and [many more](https://fastreact.dev/#features) — so you can focus on what makes your SaaS unique.
...
- **Frontend**: React 19 with React Router v7, TypeScript, TailwindCSS v4, and DaisyUI v5
...
- **Frontend Dashboard** - React SPA with system admin, organization admin (B2B mode), and user dashboards
...
FastReact includes a complete **AI Note Improver** demo application that showcases the kit's capabilities:
