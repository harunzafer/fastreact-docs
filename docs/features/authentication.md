---
description: "FastReact authentication — session-cookie auth, email/password and Google OAuth login, email verification, password reset, and role-based access control."
keywords: "fastreact authentication, session auth, google oauth, email verification, password reset, rbac, roles, fastapi auth"
---

# Authentication

FastReact ships session-based authentication out of the box: email/password and Google OAuth login, email verification, password reset, and role-based access control. Sessions are server-side and carried in an HTTP-only cookie.
