---
description: "Add Google OAuth social login to FastReact — Google Cloud credentials, redirect URIs, environment configuration, the login flow, and adding more providers."
keywords: "fastreact google oauth, social login, oauth2, google sign in, fastapi oauth, react oauth"
---

# Google OAuth

FastReact supports social login via Google OAuth out of the box, alongside [email/password authentication](authentication.md). The architecture extends to other providers.
