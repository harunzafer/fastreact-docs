---
description: "FastReact usage metering and plan limits — define per-feature quotas in plans, meter usage per billing period, and enforce limits from one generic FeatureKey system."
keywords: "fastreact usage limits, plan features, quotas, metering, featurekey, usage tracking, per-feature limits, saas quotas"
---

# Plans & Usage

FastReact meters usage and enforces per-feature limits through one generic system. The same engine powers the note quota and the AI token allotment — and you can extend it to anything.
