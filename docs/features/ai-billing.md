---
description: "FastReact AI usage and credit billing — token metering, the monthly plan allotment, non-expiring credit packs, model pricing, usage reporting, and overage settings."
keywords: "fastreact ai billing, token metering, usage-based billing, credit packs, ai credits, llm cost, usage tracking, ai saas"
---
