---
description: "Configure FastReact for B2B team collaboration - Setup closed registration, user invitations, organization management, and role-based access control for multi-tenant SaaS applications."
keywords: "b2b saas, team collaboration, organization management, user invitations, multi-tenant, role-based access, fastreact b2b mode, closed registration, saas permissions"
---

# B2B Mode

[FastReact](https://fastreact.dev) supports two operational modes: **B2C** (Business-to-Consumer) and **B2B** (Business-to-Business). This guide explains how B2B mode works.

## What is B2B Mode?

In B2B mode, FastReact operates as a closed registration system where:
